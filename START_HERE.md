...
|-----------------------------------|--------------|-------------------------------|
| **Essential** ($1,450–$1,950) | Riverside Lawn (lawn) → `/examples/riverside-lawn/` (clean live Essential reference) · Casto's unlisted demo → `/examples/castos-auto-repair` (noindex, not on homepage/sitemap — direct link only) | **Essential Care** → `site/plans/essential-care.html` |
